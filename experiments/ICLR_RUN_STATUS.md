...
Updated: 2026-06-07 18:11:06 EDT
...
| Per-row training wrapper called by the launcher | `training/run_wikitext103_optimizer_sweep.sbatch` |
| Training harness and JSONL writer | `training/transformer_wikitext103_compare.py` |
...
| `158169` | 225-239 | c4_en seed 3407 | running | 4 A6000 | 01:24:44 | `damle-compute-01` |
...
Current check: 2026-06-07 18:11:06 EDT. Running job(s): `158169`.
