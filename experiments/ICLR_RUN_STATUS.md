...
## matrixpolicyV2 E1 Rerun Status

Queued: 2026-06-19 15:04:14 EDT.

This is an isolated E1-only rerun for the new optimizer proposal. It does not
modify the completed E1/E2 paper grids.

| Field | Value |
| --- | --- |
| Proposal | `optimizer_design/proposals/matrixpolicyV2_horizontal_pressure_adam.md` |
| Manifest | `experiments/manifests/iclr26_matrixpolicyV2_e1_manifest.csv` |
...
Initial Slurm state after submission: jobs `535546` and `535547` were pending
