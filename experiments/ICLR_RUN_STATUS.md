...
Rejected V3/V4/V5 proposal files and standalone manifests were deleted from the active repo surface on 2026-06-22. The status summaries and raw run logs remain here as historical negative evidence.
