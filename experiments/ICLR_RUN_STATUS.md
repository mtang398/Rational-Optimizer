...
Queued: 2026-06-22 20:28:38 EDT. Completed: 2026-06-22 20:43:48 EDT. Decision: reject and prune. Do not queue V9 P1 or E1.

V9 was implemented with no new optimizer alias and no new source code path. It kept the original MatrixPolicy schedule that V8 showed is quality-critical, but reduced Muon Newton-Schulz iterations inside that same window. The method hypothesis was that RLB matrix conditioning may need only a sign/polar-like Muon direction, not a higher-accuracy orthogonalization. The P0 result rejects that hypothesis as a useful speed-quality tradeoff.

| Field | Value |
| --- | --- |
| Manifest | removed after failed P0; raw JSONL retained under `experiments/runs/iclr26_main/P0_matrixpolicyV9_approx_muon_500step/` |
| Phase | `P0_matrixpolicyV9_approx_muon_500step` |
| Dataset/seed | DCLM seed `1337` |
| Budget | `500` steps, `16,384,000` train tokens per row |
| Jobs | V1 control `727913`, V9 NS=3 `727914`, V9 NS=2 `727915`; all completed `0:0`, `Restarts=0` |

Result:

| Metric | V1 control | V9 NS=3 | V9 NS=2 |
| --- | ---: | ---: | ---: |
| Final val loss | 5.390707 | 5.395463 | 5.402549 |
| Validation-loss AUC | 6.366098 | 6.373829 | 6.383780 |
| Total seconds | 242.934 | 241.841 | 362.175 |
| Mean seconds/step | 0.452856 | 0.449597 | 0.690368 |
| Tokens/s | 72,358.6 | 72,883.1 | 47,464.5 |
| Mean optimizer-step s | 0.089893 | 0.084280 | 0.078633 |
