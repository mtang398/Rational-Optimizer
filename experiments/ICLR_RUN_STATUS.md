...
Updated: 2026-06-20 15:13:15 EDT
...
## matrixpolicyV3 E1 Rerun Status

Queued: 2026-06-20 15:12:39 EDT.

V2 was rejected after completed E1/E2 reruns showed it was consistently worse than original MatrixPolicy. The tracked V2 proposal and manifests have been removed from the live repo. V3 keeps the original winning MatrixPolicy mechanics and adds a modest horizontal gauge projection plus a confidence-gated Muon tail.
...
Initial Slurm state after submission: jobs `690946` and `690947` were pending for priority; rows `2-14` were dependency-held. Expected clean runtime after launch is about 4-5 hours for the full two-chain E1 set, plus queue delay.
