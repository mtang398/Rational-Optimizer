...
Updated: 2026-06-24 11:28:47 EDT
...
Current check: 2026-06-23 20:06:40 EDT. Main E2 M0/300M is complete for DCLM rows `240-284`, FineWeb-Edu rows `285-329`, FineWeb rows `330-374`, Dolma-sample rows `375-419`, and C4 rows `420-464`. Rows `465+` are E3 and were not queued. The additional E2 MatrixPolicy safe-speed timing rerun is active: jobs `810092` and `810093` are running, and jobs `810094`-`810106` are dependency-pending. Active allocation at update is 8 A6000 total.
