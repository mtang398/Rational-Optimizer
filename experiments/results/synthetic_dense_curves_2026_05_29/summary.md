...
| --- | --- | ---: | ---: | ---: | ---: |
| Code | SiLU/SwiGLU+AdamW | 1250 | 0.088662 | 1.0927 | +0.000000 |
| Code | RLB+AdamW | 1250 | 0.089919 | 1.0941 | +0.001257 |
| Code | SiLU/SwiGLU+Muon | 1250 | 0.092079 | 1.0965 | +0.003416 |
| Code | RLB+Muon | 1250 | 0.091911 | 1.0963 | +0.003248 |
| Code | RLB MatrixPolicy | 1250 | 0.091783 | 1.0961 | +0.003121 |
| Code | RLB MatrixPolicy group-stat | 1250 | 0.095702 | 1.1004 | +0.007039 |
| Symbolic | SiLU/SwiGLU+AdamW | 1250 | 0.038529 | 1.0393 | +0.000000 |
| Symbolic | RLB+AdamW | 1250 | 0.038727 | 1.0395 | +0.000198 |
| Symbolic | SiLU/SwiGLU+Muon | 1250 | 0.038800 | 1.0396 | +0.000271 |
| Symbolic | RLB+Muon | 1250 | 0.039082 | 1.0399 | +0.000553 |
| Symbolic | RLB MatrixPolicy | 1250 | 0.039208 | 1.0400 | +0.000679 |
| Symbolic | RLB MatrixPolicy group-stat | 1250 | 0.039111 | 1.0399 | +0.000582 |
| Reasoning mix | SiLU/SwiGLU+AdamW | 1250 | 0.144567 | 1.1555 | +0.000000 |
| Reasoning mix | RLB+AdamW | 1250 | 0.144184 | 1.1551 | -0.000383 |
| Reasoning mix | SiLU/SwiGLU+Muon | 1250 | 0.144301 | 1.1552 | -0.000266 |
| Reasoning mix | RLB+Muon | 1250 | 0.143449 | 1.1542 | -0.001118 |
| Reasoning mix | RLB MatrixPolicy | 1250 | 0.146135 | 1.1574 | +0.001568 |
| Reasoning mix | RLB MatrixPolicy group-stat | 1250 | 0.142429 | 1.1531 | -0.002138 |

Sources:

* `synthetic_code`: `experiments/runs/synthetic_dense_curves_20260529`, suffix `20260529_dense_curve`
* `synthetic_symbolic`: `experiments/runs/synthetic_dense_curves_20260529`, suffix `20260529_dense_curve`
* `synthetic_reasoning_mix`: `experiments/runs/synthetic_dense_curves_20260529`, suffix `20260529_dense_curve`
