...
- Non-MatrixPolicy RLB optimizer controls overlaid from global-rational RLB (`rlb_fused_global_rational`) runs: `{global_rational_rows}` aggregate row-count contributions. Early-stop rows retained in runtime aggregates: `{early_stop_rows}`.
{e2_bullets}
