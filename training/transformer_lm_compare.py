...
def main():
    ...
    config_record = {
        ...
        "factored_min_dim": args.factored_min_dim if args.optimizer == "adafactor_came" else None,
        "factored_clip_threshold": args.factored_clip_threshold if args.optimizer == "adafactor_came" else None,
