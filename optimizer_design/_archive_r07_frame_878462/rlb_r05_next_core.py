...
class R05NextCore(R01Core):
    ...
    def _select_functional_corner(
        ...
        *,
        ...
        current_incoming = torch.stack(self.incoming).float().view(shape)
        current_outgoing = torch.stack(self.outgoing).float().transpose(
            -2, -1
        ).view(shape)
        ...
        decay_group_images = self._group_tangent_images(
            functional_inputs,
            functional_preactivations,
            functional_features,
        ...
        selected_incoming_blocks = atlas_incoming * coefficients[..., None, None]
        selected_outgoing_blocks = atlas_outgoing * coefficients[..., None, None]
        ...
        self._publish_downstream_functional_atlas(
            ...
            atlas_incoming=atlas_incoming,
            atlas_outgoing=atlas_outgoing,
