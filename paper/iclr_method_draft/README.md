...
The draft should use the manifest-first matched runs described in `../../experiments/ICLR_EXACT_RUN_PLAN.md`. Current E1 tables/curves live in `../../experiments/ICLR_RUN_STATUS.md`; exact submitted commands live in `../../experiments/ICLR_RUN_COMMANDS.md`. WikiText may remain a small demo anchor when useful.
...
experiments: placeholder text; data source is current E1 status
