...
appendix: shared protocol, E1/E2 support curves, E1 target-frontier controls, endpoint sanity table, and mathematical rationale for the activation and optimizer design; E8 is explicitly provisional pending corrected reruns
